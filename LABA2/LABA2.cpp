...
int main()
{
    ...
    cout << "|| Задание 1 Создаем случайный массив ||" << "\n";
    srand(time(0));
    //*Создание нужного массива 
    int* array, max, min, maxnumber, minnumber, n, average, averagebubblesort; 
    //cin>> n;
    n = 100;// колво элементов в массиве от 0 до 100
    array = new int[n];// новый массив 
    cout << "Массив выгледит так: " << "\n";
    min = -99; 
    max = 99;
    ...
    {
        cout << "************************************************************************************" << "\n";
        cout << "*" << "                        Действия с не отсортированным массивом                    " << "*" << "\n";
        ...
        cout << "*" << "                                                                                  " << "*" << "\n";
        cout << "*" << "                        Действия с отсортированным массивом                       " << "*" << "\n";
        ...
        int keyss; //переменная 
        cin >> keyss;
        switch (keyss) // опер переключения 
        {
        ...
        case 1:
        {
            ...
            auto start0 = chrono::steady_clock::now(); // при запуске функции начинает отчёт времени 

            {
                ...
                average = (maxnumber + minnumber) / 2; // ср знач 
                cout << "Среднее значение массива  " << average << "\n";
            }
            //*** Заканчиваем момент времени_1

            auto end0 = chrono::steady_clock::now(); // при запуске функции заканчивает отчёт времени 

            cout << "Время за которое находится Max min average в несортированном: "
                << chrono::duration_cast<chrono::nanoseconds>(end0 - start0).count()     //берём время в винде 
                << " ns" << endl;
            break;
        }
        case 2: {
...

            {
                ...
                for (int ib = 0; ib < n; ib++)
                {
                    ...
                    if (array[ib] == average) {
                        call0++;  // переменная, когда находится чило равное ср значению прибавлет к себе + 1
                    }
